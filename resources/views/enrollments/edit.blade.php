...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('enrollments/' .$enrollments->id) }}" method="post">
        ...
        <input type="text" name="batch->name" id="batch->name" value="{{$enrollments->batch_id}}" class="form-control"></br>

        <label>Student</label></br>
        <input type="text" name="student->name" id="student->name" value="{{$enrollments->student_id}}" class="form-control"></br>
